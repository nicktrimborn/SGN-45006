...
for i=1:8
    plot(pproj1(1,i)/pproj1(3,i),pproj1(2,i)/pproj1(3,i),'rx','MarkerSize',15);
end
...
for i=1:8title('Cyan: manually located points  Red: projected points')
    plot(pproj2(1,i)/pproj2(3,i),pproj2(2,i)/pproj2(3,i),'rx','MarkerSize',15);
end
title('Cyan: manually located points  Red: projected points')
